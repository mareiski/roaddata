<template>
  <div class="haftungsausschluss q-px-lg q-pb-md">
    ...
    Quelle:
    <a href="http://www.haftungsausschluss-vorlage.de/"
      >Haftungsausschluss Muster</a
    >
    von <a href="http://www.haftungsausschluss.org/">Haftungsausschluss.org</a>,
    <a href="http://www.dsgvo-gesetz.info/">www.dsgvo-gesetz.info</a> und das
    <a href="http://www.datenschutzgesetz.de/">Datenschutzgesetz</a>
  </div>
</template>
<script>
